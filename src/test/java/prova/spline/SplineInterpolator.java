...
/**
 * vedi: https://gist.github.com/lecho/7627739 Performs spline interpolation
...
//      System.out.printf("m1(%d)=%8.3f\n", i, m[i]);
    ...
    for (int i = 0; i < n - 1; i++) {
      if (d[i] == 0f) { // successive Y values are equal
        ...
        //        if (h > 9f) { see: https://gist.github.com/lecho/7627739?permalink_comment_id=3498876#gistcomment-3498876
        if (h > 3f) {
          float t = 3f / h;
          m[i] = t * a * d[i];
          m[i + 1] = t * b * d[i];
