...
public class Spline extends Applet {
  ...
  public void init() {
    ...
    numpoints = 6;
    moveflag = numpoints;
    int increment = (size().width - 60) / (numpoints - 1);
  ...
  public void paint(Graphics g) {
    ...
    x1 = (int) (1.6077 * points[1].x - .26794 * points[0].x - .43062 * points[2].x + .11483 * points[3].x - .028708 * points[4].x
        + .004785 * points[5].x);
    ...
    x1 = (int) ( -.43062 * points[1].x + .07177 * points[0].x + 1.7225 * points[2].x - .45933 * points[3].x + .11483 * points[4].x
        - .019139 * points[3].x);
    y1 = (int) ( -.43062 * points[1].y + .07177 * points[0].y + 1.7225 * points[2].y - .45933 * points[3].y + .11483 * points[4].y
        - .019139 * points[3].y);

    control[2] = new Point(x1, y1);
    x1 = (int) (.11483 * points[1].x - .019139 * points[0].x - .45933 * points[2].x + 1.7225 * points[3].x - .43062 * points[4].x
        + .07177 * points[5].x);

    y1 = (int) (.11483 * points[1].y - .019139 * points[0].y - .45933 * points[2].y + 1.7225 * points[3].y - .43062 * points[4].y
        + .07177 * points[5].y);

    control[3] = new Point(x1, y1);
    x1 = (int) ( -.028708 * points[1].x + .004785 * points[0].x + .114835 * points[2].x - .43062 * points[3].x
        + 1.6077 * points[4].x - .26794 * points[5].x);

    y1 = (int) ( -.028708 * points[1].y + .004785 * points[0].y + .114835 * points[2].y - .43062 * points[3].y
        + 1.6077 * points[4].y - .26794 * points[5].y);
    ...
    for (int i = 1; i < numpoints; i++) {
      for (t = i - 1; t <= i; t += k) {
        x2 = (int) (points[i - 1].x
            + (t - (i - 1)) * ( -3 * (double) points[i - 1].x + 3 * (.6667 * control[i - 1].x + .3333 * control[i].x)
                + (t - (i - 1)) * (3 * (double) points[i - 1].x - 6 * (.6667 * control[i - 1].x + .3333 * control[i].x)
                    + 3 * (.3333 * control[i - 1].x + .6667 * control[i].x)
                    + ( -(double) points[i - 1].x + 3 * (.6667 * control[i - 1].x + .3333 * control[i].x)
                        - 3 * (.3333 * control[i - 1].x + .6667 * control[i].x) + points[i].x) * (t - (i - 1)))));
        y2 = (int) (points[i - 1].y
            + (t - (i - 1)) * ( -3 * (double) points[i - 1].y + 3 * (.6667 * control[i - 1].y + .3333 * control[i].y)
                + (t - (i - 1)) * (3 * (double) points[i - 1].y - 6 * (.6667 * control[i - 1].y + .3333 * control[i].y)
                    + 3 * (.3333 * control[i - 1].y + .6667 * control[i].y)
                    + ( -(double) points[i - 1].y + 3 * (.6667 * control[i - 1].y + .3333 * control[i].y) -

                        3 * (.3333 * control[i - 1].y + .6667 * control[i].y) + points[i].y) * (t - (i - 1)))));
